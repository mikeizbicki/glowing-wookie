...
display r1 r2 q = "<html>\n\n"
			 ...
			 ++ displayonething r1 r2 (fst q)
			 ++ "</div>\n\n"
			 ++ "<div class=\"middle\">\n"
			 ++ "<strong style=\"font-size: 100px\">or</strong>\n"
			 ++ "</div>\n\n"
			 ++ "<div class=\"queryobject\">\n"
			 ++ displayonething r1 r2 (snd q)
			 ++ "</div>\n"
			 ++ "</div>\n\n\n"
...
displayonething :: Int -> Int -> QuizData -> String
{-displayonething x = "<a href=\"ex3.html\"><div class=\"queryobject\"><img src=\"/img/" 
				 ++ getPicURL x ++ "\"><p>" ++ getName x ++ "</p></div></a>\n"
-}
displayonething r1 r2 x = "<form name=\"input\" action=\"/quiz" ++ show r1 ++ "/question" ++ show r2 ++ "\" method=\"push\" title=\"" ++ getDescription x ++ "\">\n"
